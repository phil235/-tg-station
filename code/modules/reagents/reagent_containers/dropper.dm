...
/obj/item/weapon/reagent_containers/dropper/afterattack(obj/target, mob/user , proximity)
	...
	if(reagents.total_volume > 0)
		...
		if(!target.is_open_container() && !ismob(target) && !istype(target,/obj/item/weapon/reagent_containers) && !istype(target, /obj/item/clothing/mask/cigarette)) //You can inject humans and food but you cant remove the shit.
