...
/obj/item/weapon/reagent_containers/condiment/New()
	..()
	pixel_x = rand(-5, 5)	//Randomizes postion slightly.
	pixel_y = rand(-5, 5)

/obj/item/weapon/reagent_containers/condiment/attack_self(mob/user)
	return

/obj/item/weapon/reagent_containers/condiment/attack(mob/M, mob/user, def_zone)
...
/obj/item/weapon/reagent_containers/condiment/afterattack(obj/target, mob/user , proximity)
	if(!proximity) return
	...
	else if(target.is_open_container() || istype(target, /obj/item/weapon/reagent_containers/snacks))
...
/obj/item/weapon/reagent_containers/condiment/saltshaker		//Seperate from above since it's a small shaker rather then
...
/obj/item/weapon/reagent_containers/condiment/pack
	name = "condiment pack"
...
/obj/item/weapon/reagent_containers/condiment/pack/attack(mob/M, mob/user, def_zone) //Can't feed these to people directly.
	return

/obj/item/weapon/reagent_containers/condiment/pack/afterattack(obj/target, mob/user , proximity)
	if(!proximity) return

	//You can tear the bag open above food to put the condiments on it, obviously.
	if(istype(target, /obj/item/weapon/reagent_containers/snacks))
		if(!reagents.total_volume)
...
/obj/item/weapon/reagent_containers/condiment/pack/on_reagent_change()
	if(reagents.reagent_list.len > 0)
		var/main_reagent = reagents.get_master_reagent_id()
		if(main_reagent in possible_states)
			var/list/temp_list = possible_states[main_reagent]
...
//Ketchup
/obj/item/weapon/reagent_containers/condiment/pack/ketchup
	name = "ketchup pack"
	originalname = "ketchup"
	list_reagents = list("ketchup" = 10)

//Hot sauce
/obj/item/weapon/reagent_containers/condiment/pack/hotsauce
	name = "hotsauce pack"
