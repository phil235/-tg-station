...
/obj/item/weapon/reagent_containers/snacks/proc/update_overlays(obj/item/weapon/reagent_containers/snacks/S)
...
/obj/item/weapon/reagent_containers/snacks/proc/update_name(obj/item/weapon/reagent_containers/snacks/S)
	for(var/obj/item/I in ingredients)
		if(!istype(S, I.type))
			customname = "custom"
			break
	if(ingredients.len == 1) //first ingredient
		if(istype(S, /obj/item/weapon/reagent_containers/snacks/meat))
			var/obj/item/weapon/reagent_containers/snacks/meat/M = S
			if(M.subjectname)
...
/obj/item/weapon/reagent_containers/snacks/proc/mix_filling_color(obj/item/weapon/reagent_containers/snacks/S)
...
/obj/item/weapon/reagent_containers/snacks/burger/custom
	name = "burger"
...
/obj/item/weapon/reagent_containers/snacks/store/bread/custom
	name = "bread"
	ingMax = 6
	Ingredientsplacement = INGREDIENTS_FILL
	slice_path = /obj/item/weapon/reagent_containers/snacks/breadslice/custom
	slices_num = 5
...
/obj/item/weapon/reagent_containers/snacks/store/cake/custom
	name = "cake"
	ingMax = 6
	Ingredientsplacement = INGREDIENTS_FILL
	slice_path = /obj/item/weapon/reagent_containers/snacks/cakeslice/custom
	slices_num = 5
...
/obj/item/weapon/reagent_containers/snacks/kebab/custom
	name = "brochette"
...
/obj/item/weapon/reagent_containers/snacks/custompasta
	name = "spaghetti"
...
/obj/item/weapon/reagent_containers/snacks/pie/custom
	name = "pie"
	Ingredientsplacement = INGREDIENTS_FILL
	ingMax = 6
...
/obj/item/weapon/reagent_containers/snacks/pizza/custom
	name = "pizza"
	desc = "A personalized pan pizza meant for only one person."
	Ingredientsplacement = INGREDIENTS_SCATTER
	ingMax = 8
	slice_path = /obj/item/weapon/reagent_containers/snacks/pizzaslice/custom
	slices_num = 6
...
/obj/item/weapon/reagent_containers/snacks/salad/custom
	name = "salad"
	desc = "Very tasty."
	Ingredientsplacement = INGREDIENTS_FILL
	ingMax = 6
...
/obj/item/weapon/reagent_containers/snacks/customsandwich
	name = "sandwich"
	desc = "A timeless classic."
	ingMax = 12
	Ingredientsplacement = INGREDIENTS_STACK
...
/obj/item/weapon/reagent_containers/snacks/soup/custom
	name = "soup"
