...
/obj/item/weapon/reagent_containers/snacks/soup/New()
	..()
	eatverb = pick("slurp","sip","suck","inhale","drink")

/obj/item/weapon/reagent_containers/snacks/soup/wish
	name = "wish soup"
	desc = "I wish this was soup."
	icon_state = "wishsoup"
	list_reagents = list("water" = 10)

/obj/item/weapon/reagent_containers/snacks/soup/wish/New()
	..()
	if(prob(25))
...
/obj/item/weapon/reagent_containers/snacks/soup/meatball
	name = "meatball soup"
	desc = "You've got balls kid, BALLS!"
	icon_state = "meatballsoup"
	bonus_reagents = list("nutriment" = 1, "vitamin" = 5)

/obj/item/weapon/reagent_containers/snacks/soup/slime
	name = "slime soup"
...
/obj/item/weapon/reagent_containers/snacks/soup/blood
	name = "tomato soup"
...
/obj/item/weapon/reagent_containers/snacks/soup/wingfangchu
	name = "wing fang chu"
...
/obj/item/weapon/reagent_containers/snacks/soup/clownstears
	name = "clown's tears"
	desc = "Not very funny."
...
/obj/item/weapon/reagent_containers/snacks/soup/vegetable
	name = "vegetable soup"
	desc = "A true vegan meal."
	icon_state = "vegetablesoup"
	bonus_reagents = list("nutriment" = 1, "vitamin" = 4)

/obj/item/weapon/reagent_containers/snacks/soup/nettle
	name = "nettle soup"
	desc = "To think, the botanist would've beat you to death with one of these."
	icon_state = "nettlesoup"
	bonus_reagents = list("nutriment" = 1, "omnizine" = 5, "vitamin" = 5)

/obj/item/weapon/reagent_containers/snacks/soup/mystery
	name = "mystery soup"
...
/obj/item/weapon/reagent_containers/snacks/soup/mystery/New()
	..()
...
/obj/item/weapon/reagent_containers/snacks/soup/hotchili
	name = "hot chili"
...
/obj/item/weapon/reagent_containers/snacks/soup/coldchili
	name = "cold chili"
...
/obj/item/weapon/reagent_containers/snacks/soup/monkeysdelight
...
/obj/item/weapon/reagent_containers/snacks/soup/tomato
	name = "tomato soup"
...
/obj/item/weapon/reagent_containers/snacks/soup/milo
	name = "milosoup"
	desc = "The universes best soup! Yum!!!"
	icon_state = "milosoup"
	bonus_reagents = list("nutriment" = 1, "vitamin" = 3)

/obj/item/weapon/reagent_containers/snacks/soup/mushroom
...
/obj/item/weapon/reagent_containers/snacks/soup/beet
	name = "beet soup"
	desc = "Wait, how do you spell it again..?"
	icon_state = "beetsoup"
	bonus_reagents = list("nutriment" = 1, "vitamin" = 5)

/obj/item/weapon/reagent_containers/snacks/soup/beet/New()
	..()
	name = pick("borsch","bortsch","borstch","borsh","borshch","borscht")


/obj/item/weapon/reagent_containers/snacks/soup/spacylibertyduff
...
/obj/item/weapon/reagent_containers/snacks/soup/amanitajelly
	name = "amanita jelly"
...
/obj/item/weapon/reagent_containers/snacks/soup/stew
	name = "stew"
...
/obj/item/weapon/reagent_containers/snacks/soup/sweetpotato
	name = "sweet potato soup"
	desc = "Delicious sweet potato in soup form."
	icon_state = "sweetpotatosoup"
	bonus_reagents = list("nutriment" = 4, "vitamin" = 5)

/obj/item/weapon/reagent_containers/snacks/soup/beet/red
	name = "red beet soup"
