...
/obj/machinery/conveyor/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/weapon/crowbar)) //phil235 should be replaced by default_deconstruction
		if(!(stat & BROKEN))
		...
		qdel(src)
		return
	if(istype(I, /obj/item/weapon/wrench))	//phil235 replaced by default_wrench_stuff
		if(!(stat & BROKEN))
