/mob/living/simple_animal/hostile/mushroom
	...
	maxHealth = 10
	health = 10
	butcher_results = list(/obj/item/weapon/reagent_containers/snacks/hugemushroomslice = 1)
	response_help  = "pets"
...
/mob/living/simple_animal/hostile/mushroom/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/weapon/reagent_containers/snacks/grown/mushroom))
...
/mob/living/simple_animal/hostile/mushroom/harvest()
	...
	for(counter=0, counter<=powerlevel, counter++)
		var/obj/item/weapon/reagent_containers/snacks/hugemushroomslice/S = new /obj/item/weapon/reagent_containers/snacks/hugemushroomslice(src.loc)
