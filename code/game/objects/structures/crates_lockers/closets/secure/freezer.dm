...
/obj/structure/closet/secure_closet/freezer/kitchen/New()
	...
	new /obj/item/weapon/reagent_containers/condiment/rice(src)
...
/obj/structure/closet/secure_closet/freezer/meat/New()
	..()
	for(var/i = 0, i < 4, i++)
		new /obj/item/weapon/reagent_containers/snacks/meat/slab/monkey(src)
...
/obj/structure/closet/secure_closet/freezer/fridge/New()
	..()
	for(var/i = 0, i < 5, i++)
		new /obj/item/weapon/reagent_containers/condiment/milk(src)
	for(var/i = 0, i < 5, i++)
		new /obj/item/weapon/reagent_containers/condiment/soymilk(src)
	for(var/i = 0, i < 2, i++)
