	...
	switch(pick(possiblethemes))//what kind of room is this gonna be?
		...
		if("cavein")
			...
			fluffitems = list(/obj/effect/decal/cleanable/blood=3,/obj/effect/decal/remains/human=1,/obj/item/clothing/under/overalls=1,
							  /obj/item/weapon/reagent_containers/snacks/grown/chili=1,/obj/item/weapon/tank/internals/oxygen/red=2)
		...
		if("speakeasy")
			...
			fluffitems = list(/obj/structure/table/wood=2,/obj/structure/reagent_dispensers/beerkeg=1,/obj/item/stack/spacecash/c500=4,
							  /obj/item/weapon/reagent_containers/drinks/shaker=1,/obj/item/weapon/reagent_containers/drinks/bottle/wine=3,
							  /obj/item/weapon/reagent_containers/drinks/bottle/whiskey=3,/obj/item/clothing/shoes/laceup=2)
